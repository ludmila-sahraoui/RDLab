  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <h1 className="text-2xl font-semibold text-purple-dark">About</h1>
      </header>
        <div className="mb-4">
        ...
        <div className="mb-6">
          <div className="flex items-center mb-2">
            <div className="w-5 h-5 rounded-full border-2 border-purple-dark flex items-center justify-center mr-2">
              <span className="text-purple-dark text-xs font-bold">i</span>
            </div>
        ...
        <div className="mb-6">
          <div className="flex items-center mb-3">
            <div className="w-5 h-5 mr-2">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-purple-dark">
        ...
        <div>
          ...
          <div className="ml-7">
            ...
            <div className="text-sm">
              <a href="mailto:rdlab-support@example.com" className="text-purple-dark hover:text-blue-800 block">
                rdlab-support@example.com
              </a>
              <a href="http://www.rdlab-platform.example" className="text-purple-dark hover:text-blue-800 block">
